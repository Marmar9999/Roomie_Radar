...
class QuestionnaireViewModel {
  var introductionText= 'Welcome to our Roommie Radar! This short survey will help us understand your preferences and find the perfect roommate match for you. Answer the questions honestly to maximize your chances of finding a compatible living partner! And finally GoodLuck!';
  ...
  List<Question> getQuestions() {
    return [
      Question(
        ...
        onAnswerSelected: (String answer) {print(answer);  },
      ),
      Question(
        questionText: 'How tidy are you?',
        answers: const ['Very tidy', 'Moderately tidy', 'Not very tidy', 'Messy'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
      Question(
      ...
      Question(
        ...
        answers: const ['Love them', 'Okay with them', 'Prefer not', 'Allergic'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
      Question(
      ...
      Question(
        ...
        answers: const ['Open to it', 'Only essentials', 'Prefer separate', 'No way'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
      Question(
      ...
      Question(
        ...
        answers: const ['Vegetarian', 'Vegan', 'Gluten-free', 'No restrictions'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
      Question(
        questionText: 'How do you handle conflict?',
        answers: const ['Directly', 'Prefer to avoid', 'Need time to cool off', 'Depends'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
      Question(
        questionText: 'Are you comfortable sharing household chores?',
        answers: const ['Yes, equally', 'Prefer my own tasks', 'Only my area', 'No'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
      Question(
      ...
      Question(
        ...
        answers: const ['Split evenly', 'Pay my share', 'Rotate bills', 'Depends'],
        onAnswerSelected: (String answer) { print(answer); },
      ),
    ];
